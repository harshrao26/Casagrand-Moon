    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <button onClick={openLeadForm} className="inline-flex w-full items-center justify-center gap-3 rounded-full bg-[#BD9E5A] px-8 py-4 text-xs font-extrabold uppercase tracking-[2px] text-white shadow-[0_18px_45px_rgba(199,131,5,0.25)] transition hover:bg-black sm:w-auto sm:min-w-[280px]">
